...
const resList = [
  {
    ...
    data: {
      ...
      cloudinaryImageId:
        "https://dineout-media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/DINEOUT_ALL_RESTAURANTS/IMAGES/RESTAURANT_IMAGE_SERVICE/2025/6/1/9c3ccca2-aa4c-45ab-b85d-8fe179edbeca_20250601T110220991.jpg",
  ...
  },
  {
    ...
    data: {
      ...
      totalRatingsString: "10000+ ratings",
      cloudinaryImageId:
        "http://dineout-media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/DINEOUT_ALL_RESTAURANTS/IMAGES/RESTAURANT_IMAGE_SERVICE/2024/8/16/a2be97c9-5faa-4852-9d65-8c05db518ed5_DSC03699efb4fa9bf14140748336a30f5b713d27.JPG",
      cuisines: [
        "Biryani",
        "Andhra",
        "South Indian",
  ...
  },
  {
    ...
    data: {
      ...
      totalRatingsString: "10000+ ratings",
      cloudinaryImageId:
        "https://dineout-media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/DINEOUT_ALL_RESTAURANTS/IMAGES/RESTAURANT_IMAGE_SERVICE/2025/6/1/de647db5-6bf2-4530-ad90-c8130c18b266_20250601T110221814.jpg",
  ...
  },
  {
    ...
    data: {
      ...
      totalRatingsString: "10000+ ratings",
      cloudinaryImageId:
        "https://dineout-media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/DINEOUT_ALL_RESTAURANTS/IMAGES/RESTAURANT_IMAGE_SERVICE/2024/8/16/92e05b1d-f351-4f26-9bf0-b0c2de51daeb_DSC03719548abc3bb57040c393004ccf02b3a255.JPG",
  ...
  },
  {
    ...
    data: {
      ...
      totalRatingsString: "10000+ ratings",
      cloudinaryImageId:
        "https://dineout-media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/DINEOUT_ALL_RESTAURANTS/IMAGES/RESTAURANT_IMAGE_SERVICE/2024/8/16/62b5f0ce-23a5-4707-98f1-289d69c38fb0_DSC037297fd7878319774e7f9da2f9dd36471d1e.JPG",
      cuisines: [
        "American",
        "Arabian",
        "Chinese",
  ...
  return (
    <div className="body">
      ...
      <div className="restaurant-container">
        {/* <RestaurantCard restObject={resList[0]} />
        <RestaurantCard restObject={resList[1]} />
        <RestaurantCard restObject={resList[2]} />
        <RestaurantCard restObject={resList[3]} />
        <RestaurantCard restObject={resList[4]} />
        <RestaurantCard restObject={resList[5]} />
        <RestaurantCard restObject={resList[6]} />
        <RestaurantCard restObject={resList[7]} />
        <RestaurantCard restObject={resList[8]} />
        <RestaurantCard restObject={resList[9]} />
        <RestaurantCard restObject={resList[10]} />
        <RestaurantCard restObject={resList[11]} />
        <RestaurantCard restObject={resList[12]} /> */}
